                        ...
                        <div className="container mx-auto relative z-20">
                            <div className="w-full h-full relative">
                                <div className="w-full h-full">
                                    <img className="w-4/5 shadow-kow-shadow-sm" src="/img/Blog-Images/blogPhoto1.png" alt="" />
                                </div>
                                <div className="absolute bottom-0 -right-[100px] -z-10 w-[400px] h-[400px] opacity-60">
                                    <img src="/img/Blog-Images/circle.png" alt="" className="w-full h-full"/>
                                </div>
                                <div className="bg-[#7c9c30] shadow-kow-shadow-sm py-10 pl-10 absolute -bottom-20 right-0 flex flex-col gap-3">
                                    <h1 className="text-white text-3xl pb-1 font-bold pr-10 border-b-[1px] border-[#6f8a0e]">Easy Product<br />
                                        Photography Solutions for Small Business</h1>
