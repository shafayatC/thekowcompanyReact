...
import Image3DViewDrag from '../Image3DView/Image3DViewDrag';
                    ...
                    imageList.length == 0 ?
                        <Suspense fallback={<div className='w-full h-full bg-slate-400 animate-pulse'></div>}>
                            <div>
                                ...
                                <img draggable='false' className='absolute top-0 left-0 w-full h-full' src={imgSample} />
...

                {
                    ...
                    <div className={`${getViewSample && imageList.length > 0 ? 'w-full h-full' : 'hidden'}`}>
                        <Suspense fallback={<ViewLoading imgSample={imgSample} />}>
                            ...
                            <Image3DViewDrag imageList={imageList} />
                        </Suspense>
                    </div>
