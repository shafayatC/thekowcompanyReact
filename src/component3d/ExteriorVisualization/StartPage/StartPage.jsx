            ...
            <div className='container mx-auto'>
                <div className='flex relative justify-center px-2 md:px-0'>
                    <div className='relative z-10'>
                        <h3 className='text-5xl text-[80px] md:text-[95px]  leading-[60px] font-bold md:leading-[80px]'>EXTERIOR</h3>
                    ...
                    <img className='absolute left-0 -top-[150px] md:-top-[170px] xl:-top-[170px] 2xl:-top-[250px] h-[360px] md:h-auto w-[360px] md:w-[500px] xl:w-[600px] 2xl:w-[700px] z-0' src='/img/3d/eev.svg' />
                </div>
            </div>
        </div>
    );
