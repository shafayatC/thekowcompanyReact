            ...
            <div className='container mx-auto'>
                <div className='flex relative justify-center px-2 md:px-0'>
                    <div className='relative z-10'>
                        <h3 className='text-5xl ml-24 md:ml-0  md:text-[95px]  leading-[60px] font-bold md:leading-[80px]'>FURNITURES</h3>
                    ...
                    <img className='absolute left-0 -top-[150px] md:-top-[170px] xl:-top-[180px] 2xl:-top-[250px] h-[330px] md:h-auto w-[420px] md:w-[550px] xl:w-[600px] 2xl:w-[800px] z-9' src='/img/3d/IV.png' />
                </div>
            </div>
        </div>
    );
