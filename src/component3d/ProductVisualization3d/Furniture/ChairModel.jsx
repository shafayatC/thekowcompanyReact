...
const ChairModel = () => {
      ...
      if (node.type === 'Mesh') {
        ...
        return (
          <mesh
            ...
            onPointerOver={(e) => (e.stopPropagation(), set(e.object.material.name), console.log(color))}
  ...
  const renderColors = (e) => {
    ...
    if (getModelObject != null) {
      setColors(prevState => ({
        ...colors,  // Spread the previous state to avoid mutating it
  ...
  return (
    <div className='h-[600px] relative'>
      ...
      <div className='absolute bottom-4 right-4'>
        <HexColorPicker color={color} onChange={renderColors} />
      </div>
    </div>
  );
};
