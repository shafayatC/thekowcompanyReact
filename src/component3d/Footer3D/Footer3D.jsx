            ...
            <div id="footer" className="bg-gradient-to-b to-[#8ebd8f] via-[#b3cda7] from-[#c7e0c0]">
                <footer className="footer container pt-10 pb-10 mx-auto lg:justify-items-center justify-items-center  text-[#003333] gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div className="flex flex-col text-[#333333] lg:items-start md:-ml-16 md:items-start text-center md:text-start gap-1">
                        <span className="text-lg font-semibold mb-2 ">HOME</span>
                    ...
                    <div className="flex lg:items-start text-[#333333] md:items-start flex-col md:-ml-16 text-center md:text-start  gap-1  lg:-ml-0">
                    ...
                    <div className="text-center flex flex-col items-center  md:ml-0 lg:ml-0">
                        <span className="font-bold text-[#333333] text-lg w-full text-center  md:mb-4 md:ml-8 lg:-ml-16">
                            Our Address
                        </span>
                        <iframe
